...
export default function ManageSurpriseImagesPage() {
      ...
      <main className="flex-1 py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h1 className="text-4xl font-bold tracking-tight">Manage Surprise Images</h1>
            <Button asChild>
              <Link href="/admin/surprise-images/new">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>View, edit, or delete your surprise images.</CardDescription>
            </CardHeader>
            <CardContent>
              {images.length === 0 ? (
                    ...
                    <div key={image._id} className="border rounded-lg p-4">
                      ...
                      <div className="flex items-center gap-2 mt-4">
                         <Button variant="outline" size="icon" asChild>
                           <Link href={`/admin/surprise-images/edit/${image._id}`}>
