...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant providing information about Aayush Bhatta. Use the provided context to answer the following question about Aayush Bhatta: {{{question}}}.\n`,
});
